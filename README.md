...
4. **Place the 4 edge cameras** around the locked stage — first measurement: the IMX323 stock lens's actual sharp-focus distance (stock 61°H / ~30cm focus can't cover a 6.4" edge from ~4.4" — expect a wider close-focus M12 swap or corner/standoff mounting). This gates the lighting purchase ([`hardware/README.md`](hardware/README.md)).
